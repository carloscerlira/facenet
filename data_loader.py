...
class TripletFaceDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        anc_path  = self.root_dir+"/"+str(pos_name)+"/"+str(anc_id)+'.jpg'
        pos_path  = self.root_dir+"/"+str(pos_name)+"/"+str(pos_id)+'.jpg'
        neg_path  = self.root_dir+"/"+str(neg_name)+"/"+str(neg_id)+'.jpg'

        anc_img = io.imread(anc_path)
        pos_img = io.imread(pos_path)
        neg_img = io.imread(neg_path)
